...
continue_button = Button(
    root, text="Continue", width=20, height=2, bg="cyan", command=contacts_continue
)
continue_button.grid_forget()
select_all_button = Button(
    root, text="Select all", bg="orange", width=20, height=2, command=selectall
)
...
viewmsgbutton = Button(
    root, text="View/Edit message", bg="cyan", width=20, height=2, command=vieweditmsg
)
